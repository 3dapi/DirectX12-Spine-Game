...
int UiBegin::Init()
{
	...
	//{
	//	std::string text = "DX12";
	//	auto [fontTex, sizeTex, sizeSrc] = StringTexture::CreateStringTexture("고도 B", 48, text);
	//	m_uiTex.insert(std::make_pair("ui_font bigTitle0", UI_TEXTURE{fontTex, sizeTex, {}, sizeSrc}));
	//}
	//{
	//	std::string text = "Shooting";
	//	auto [fontTex, sizeTex, sizeSrc] = StringTexture::CreateStringTexture("고도 B", 48, text);
	//	m_uiTex.insert(std::make_pair("ui_font bigTitle1", UI_TEXTURE{fontTex, sizeTex, {}, sizeSrc}));
	//}
...
int UiBegin::Draw()
{
	...
	{
		//{
		//	auto& texScore = m_uiTex["ui_font bigTitle0"];
		...
		//}
		//{
		//	auto& texScore = m_uiTex["ui_font bigTitle1"];
		//	XMFLOAT2 position = {160.0F, 380.0F};
		//	XMFLOAT2 origin = {0.0F, 0.0F};
	...
	{
		{
			...
			XMFLOAT2 position = { screenSize.cx / 2.0F - tex.size.x / 2.0F + 100.0F, 620.0F };
			XMFLOAT2 origin = { 0, 0 };
